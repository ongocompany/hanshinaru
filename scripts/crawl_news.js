...
3. relevant=true인 기사의 본문은 **원문을 최대한 그대로 사용**
4. 원문이 500자 이상이면 핵심만 추려서 요약 (300~500자)
5. 원문이 300자 미만이면 **원문 그대로 출력** (절대 내용을 추가하거나 지어내지 마세요)
6. 요약은 50자 내외, 추측/과장/창작 절대 금지
7. 제목은 원문 제목을 그대로 사용하되, 너무 길면 축약만 가능
...
[{
  ...
  "title": "원문 제목 그대로 또는 축약",
  "summary": "1줄 요약 (50자 이내)",
  "body": "원문 본문 그대로 또는 긴 경우 요약 (300~500자)",
  "keywords": ["키워드1", "키워드2"]
}]
