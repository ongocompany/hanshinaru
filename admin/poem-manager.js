...
function renderOwnedReadonlySection(poem) {
  ...
  const tZEl = document.getElementById("pf-titleZhOwned-view");
  const tKEl = document.getElementById("pf-titleKoOwned-view");
  const pZEl = document.getElementById("pf-poemZhOwned-view");
  const trEl = document.getElementById("pf-translationKoOwned-view");
  const jpEl = document.getElementById("pf-jipyeongKoOwned-view");
  const cmEl = document.getElementById("pf-commentaryKoOwned-view");
  ...
  if (tZEl) tZEl.value = poem?.titleZhOwned || "";
  if (tKEl) tKEl.value = poem?.titleKoOwned || "";
  if (pZEl) pZEl.value = poem?.poemZhOwned || "";
  if (trEl) trEl.value = poem?.translationKoOwned || "";
  if (jpEl) jpEl.value = poem?.jipyeongKoOwned || "";
  if (cmEl) cmEl.value = poem?.commentaryKoOwned || "";
