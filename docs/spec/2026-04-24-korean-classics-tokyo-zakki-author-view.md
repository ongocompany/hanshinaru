...
- 시인별 보기: [korean-classics-tokyo-zakki-author-view.v1.json](/Users/jinwoo/Documents/development/hanshinaru/docs/spec/korean-classics-tokyo-zakki-author-view.v1.json:1)
...
3. `東京雜記` 외 다른 문헌에도 같은 시인별 보기 계층을 확장한다.
